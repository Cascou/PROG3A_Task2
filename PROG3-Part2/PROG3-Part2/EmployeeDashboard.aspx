<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDashboard.aspx.cs" Inherits="PROG3_Part2.EmployeeDashboard" %>
...
<body style="height:1200px">
    <form runat="server" style="background-color:lightblue; height:100%;">
        ...
        <div class="container body-content" style="height:100%;">
            <div class="jumbotron">
                <p style="font-size: 30px"> Welcome the employee dashboard</p>
                <p style="font-size: 16px"> To view all <a runat="server" href="~/farmers">farmers</a></p>
                <p style="font-size: 16px"> To add a <a runat="server" href="~/addFarmer">farmer</a></p>
                <p style="font-size: 16px"> To view all farmers <a runat="server" href="~/employeeProduct">products</a></p>
            </div>
            <hr />
            <footer>
